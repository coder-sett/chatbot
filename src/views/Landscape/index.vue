        ...
        <div class="p-4 flex gap-2 flex-wrap">
          ...
          >
            <el-tooltip
              ...
              :show-after="200"
            >
              <img :src="z.imgUrl" :p="z.三方库名称" />
            </el-tooltip>
          </div> -->
          <div
            class="w-48 h-14 border flex items-center border-[#cbcbcd] cursor-pointer p-2"
            v-for="(z, i) of rowDataObj[item]"
            @click="showDialog(z)"
          >
            <img
            ...
            />
            <div
              class="ml-2 overflow-hidden text-black whitespace-nowrap overflow-ellipsis"
            >
              {{ z.三方库名称 }}
            </div>
          </div>
