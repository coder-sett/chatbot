...
<template>
  <div class="w-full mb-4 cursor-pointer">
    ...
    >
      ...
      <el-table-column label="学科能力(均分)" prop="e" width="150" align="center">
      </el-table-column>
      <el-table-column label="C-Eval" prop="f" width="" align="center"
        >{{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}
      </el-table-column>
      <el-table-column label="AGIEval" prop="g" width="" align="center"
        >{{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}
      </el-table-column>
      <el-table-column label="MMLU" prop="h" width="" align="center">
        {{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}</el-table-column
      >
      <el-table-column label="CMMLU" prop="i" width="" align="center"
        >{{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}
      </el-table-column>
      <el-table-column label="GAOKAO-Bench" prop="j" width="150" align="center">
        {{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}</el-table-column
      >
      <el-table-column label="ARC-c" prop="k" width="" align="center">
        {{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}</el-table-column
      >
      <el-table-column label="ARC-e" prop="l" width="" align="center"
        >{{ Math.floor(Math.random() * (90 - 40 + 1)) + 40 }}
      </el-table-column>
    </el-table>
  </div>
